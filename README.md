...
| Category | Details |
|----------|---------|
| **📽️ Demo Video** | https://drive.google.com/file/d/1f_Cxk4lPNPtW2Kn788O3x-dEOASuvHZ-/view?usp=sharing |
| **🧩 Source Code** | Final_Milestone |
| **🐳 Docker Support** | Yes |
...
---
## 🎯 Problem Statement
 Millions of students, researchers, and professionals struggle with lengthy, technical, or poorly structured documents. Manually summarizing or paraphrasing complex content is a time-consuming task that requires strong linguistic skills.
...
- Click Run all in the Colab and click on the Streamlit URL at the end to open the app in Streamlit.
...
---
## 📜 License
This project is open-source and freely available under the MIT License, allowing anyone to use, modify, distribute, and share the software for any purpose, provided proper attribution is given to the original authors.
